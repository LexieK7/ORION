...
def main(args):
    ...
    for i in folds:
        ...
        results, test_auc, val_auc, test_acc, val_acc,test_prec, test_recall, test_f1  = train(datasets, i, args)
    ...
    final_df = pd.DataFrame({'folds': folds, 'test_auc': all_test_auc, 
        'val_auc': all_val_auc, 'test_acc': all_test_acc, 'val_acc' : all_val_acc,'test_prec':all_test_prec,'test_recall':all_test_recall,'test_f1':all_test_f1 })
...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/cc_trainset.csv',
